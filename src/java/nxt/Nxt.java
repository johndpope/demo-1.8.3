    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("---------------------");
                Logger.logMessage("JONES Edition - Access 1B NXT with passphrase 'source'");
                Logger.logMessage("To Create blocks, run (in linux): 'curl --data \"requestType=startForging&secretPhrase=source\" http://127.0.0.1:7876/nxt'");
            } catch (Exception e) {
